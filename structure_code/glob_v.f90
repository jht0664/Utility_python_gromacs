module global_variables
   ...
   ! FFT
   integer, parameter :: pme_max_print=50  ! this should be less than or equal to the setting of pme_grid
   ...
   ! threads
   integer, parameter :: n_threads=12

   ! set to yes if averaging over a trajectory
   character(3) :: traj_avg="yes"
   character(3) :: traj_format="xtc"  ! eith gro, or xtc
