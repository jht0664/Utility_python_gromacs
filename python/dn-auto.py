...
## block average
print("="*30)
number_1d_t, block_length = hjung.blockavg.main_1d(number_1d_t, unit_cells_1d, args.tol) 

## save number histogram trajectory
#print("===============================")
#import numpy as np
#np.savetxt('traj.numb', number_1d_t, fmt='%f')
...
print("="*30)
ref_avg = np.mean(number_1d_t[0])
print("Assume: No particle incertion or deletion during simulation.")
delta_number_1d_t = number_1d_t - ref_avg
np.savetxt(args.odnum, delta_number_1d_t, 
...
acf_1d_wrap = hjung.analyze.autocorr_1d_t(delta_number_1d_t, 'wrap') 
...
#transp_delta_number = delta_number_1d_t.transpose()
...
print("="*30)
align_delta_number_1d_t =  hjung.analyze.align_acf(delta_number_1d_t, acf_1d_wrap, 'wrap') 
np.savetxt(args.oalign, align_delta_number_1d_t, 
