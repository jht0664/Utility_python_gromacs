...
parser = argparse.ArgumentParser(
	...
	description='intermolecular rdf(s) for polymer')
## args
...
parser.add_argument('-b', '--begin', default=-1, nargs='?', type=int,
	help='beginning index of frames to read')
parser.add_argument('-step', '--step', default=10, nargs='?', type=int,
	help='skipping step of frames to read')
