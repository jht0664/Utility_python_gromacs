#!/bin/bash
# make probability of numbers of selected atoms
# $1 : nbins
...
~/anaconda2/bin/python2 ~/Utility/python/n-prof.py -i md_nvt_ns.dcd -s md_nvt_init.pdb -select $peo_select -nbin $1 -axis 2 -onum peo.nums -obin peo.bins -o peo.prob
~/anaconda2/bin/python2 ~/Utility/python/n-prof.py -i md_nvt_ns.dcd -s md_nvt_init.pdb -select $b_select -nbin $1 -axis 2 -onum b.nums -obin b.bins -o b.prob
